                    ...
                    <div className="row mb-5">
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4">
                                <h2 className="ftco-heading-2">About MeetUp.</h2>
                        ...
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4 ml-md-4">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Schedule</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Speakers</a>
                                    </li>
                        ...
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4">
                                ...
                                <ul className="list-unstyled">
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Career</a></li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>About Us</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Contact Us</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Buy Ticket</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
